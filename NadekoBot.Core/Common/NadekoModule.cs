...
{
    public abstract class EvilMortyTopLevelModule : ModuleBase
    {
        ...
        public EvilMortyStrings _strings { get; set; }
        ...
        protected EvilMortyTopLevelModule(bool isTopLevelModule = true)
        {
        ...
        //{
        //    var title = EvilMortyBot.ResponsesResourceManager.GetString(titleKey, cultureInfo);
        //    var text = EvilMortyBot.ResponsesResourceManager.GetString(textKey, cultureInfo);
    ...
    public abstract class EvilMortyTopLevelModule<TService> : EvilMortyTopLevelModule where TService : INService
    {
        public TService _service { get; set; }

        public EvilMortyTopLevelModule(bool isTopLevel = true) : base(isTopLevel)
        {
        }
    }

    public abstract class EvilMortySubmodule : EvilMortyTopLevelModule
    {
        protected EvilMortySubmodule() : base(false) { }
    }

    public abstract class EvilMortySubmodule<TService> : EvilMortyTopLevelModule<TService> where TService : INService
    {
        protected EvilMortySubmodule() : base(false)
        {
        }
