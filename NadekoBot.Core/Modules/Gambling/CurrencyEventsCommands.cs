...
using EvilMortyBot.Core.Modules.Gambling.Common.Events;
using System;
...
namespace EvilMortyBot.Modules.Gambling
{
    ...
    {
        [Group]
        public class CurrencyEventsCommands : EvilMortySubmodule<CurrencyEventsService>
        {
            ...
            [EvilMortyOptions(typeof(EventOptions))]
            [OwnerOnly]
