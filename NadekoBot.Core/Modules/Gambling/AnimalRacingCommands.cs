...
using EvilMortyBot.Core.Modules.Gambling.Common.AnimalRacing;
using EvilMortyBot.Core.Services;
using EvilMortyBot.Extensions;
using EvilMortyBot.Modules.Gambling.Common.AnimalRacing;
using EvilMortyBot.Modules.Gambling.Common.AnimalRacing.Exceptions;
...
namespace EvilMortyBot.Modules.Gambling
{
    public partial class Gambling
    {
        ...
        public class AnimalRacingCommands : GamblingSubmodule<AnimalRaceService>
        {
            ...
            [EvilMortyOptions(typeof(RaceOptions))]
