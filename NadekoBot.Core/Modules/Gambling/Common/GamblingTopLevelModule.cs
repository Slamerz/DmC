...
using EvilMortyBot.Modules;
using System.Threading.Tasks;

namespace EvilMortyBot.Core.Modules.Gambling.Common
{
    public abstract class GamblingTopLevelModule<TService> : EvilMortyTopLevelModule<TService> where TService: INService
    {
