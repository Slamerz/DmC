...
using EvilMortyBot.Modules.Games.Common.Hangman;
using EvilMortyBot.Modules.Games.Common.Trivia;
using EvilMortyBot.Modules.Games.Common.Nunchi;
...
namespace EvilMortyBot.Modules.Games.Services
{
    public class GamesService : INService, IUnloadableService
    {
        ...
        private readonly EvilMortyRandom _rng;
        ...
        public GamesService(CommandHandler cmd, IBotConfigProvider bc, EvilMortyBot bot,
            EvilMortyStrings strings, IDataCache data, CommandHandler cmdHandler,
            ICurrencyService cs)
        {
            _bc = bc;
            _cmd = cmd;
