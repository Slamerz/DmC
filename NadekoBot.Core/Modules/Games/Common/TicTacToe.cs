...
namespace EvilMortyBot.Modules.Games.Common
{
    public class TicTacToe
    {
        public class Options : IEvilMortyCommandOptions
        {
        ...
        public TicTacToe(EvilMortyStrings strings, DiscordSocketClient client, ITextChannel channel, 
