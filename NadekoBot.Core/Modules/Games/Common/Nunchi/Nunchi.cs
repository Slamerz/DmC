...
namespace EvilMortyBot.Modules.Games.Common.Nunchi
{
    public class Nunchi : IDisposable
    {
        ...
        public int CurrentNumber { get; private set; } = new EvilMortyRandom().Next(0, 100);
        ...
        private void EndRound((ulong, string)? failure = null)
        {
            ...
            CurrentNumber = new EvilMortyRandom().Next(0, 100); // reset the counter
