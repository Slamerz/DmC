...
namespace EvilMortyBot.Modules.Games
{
    ...
    */
    public partial class Games : EvilMortyTopLevelModule<GamesService>
    {
...
//#endif
        ...
        public async Task EightBall([Remainder] string question = null)
        {
            ...
            await Context.Channel.EmbedAsync(new EmbedBuilder().WithColor(EvilMortyBot.OkColor)
                               ...
                               .AddField(efb => efb.WithName("🎱 " + GetText("8ball")).WithValue(_service.EightBallResponses[new EvilMortyRandom().Next(0, _service.EightBallResponses.Length)]).WithIsInline(false)));
        }
