...
namespace EvilMortyBot.Modules.Permissions.Services
{
    public class PermissionService : ILateBlocker, INService
    {
        ...
        public PermissionService(DiscordSocketClient client, DbService db, CommandHandler cmd, EvilMortyStrings strings)
        {
            _db = db;
            _cmd = cmd;
            _strings = strings;
