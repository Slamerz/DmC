...
using EvilMortyBot.Modules.Music.Common.Exceptions;
using EvilMortyBot.Modules.Music.Extensions;
using EvilMortyBot.Modules.Music.Services;
using Newtonsoft.Json.Linq;

namespace EvilMortyBot.Modules.Music
{
    [NoPublicBot]
    public class Music : EvilMortyTopLevelModule<MusicService>
    {
        ...
        public async Task SoundCloudPl([Remainder] string pl)
        {
            ...
            {
                var scvids = JObject.Parse(await http.GetStringAsync($"https://scapi.evilMortybot.me/resolve?url={pl}").ConfigureAwait(false))["tracks"].ToObject<SoundCloudVideo[]>();
                IUserMessage msg = null;
        ...
        public async Task MoveSong([Remainder] string fromto)
        {
            ...
            var embed = new EmbedBuilder()
                ...
                .WithColor(EvilMortyBot.OkColor);
