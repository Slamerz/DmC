...
using NLog;
using EvilMortyBot.Modules.Utility.Extensions;
using EvilMortyBot.Common.TypeReaders;
using EvilMortyBot.Modules.Utility.Common;
using EvilMortyBot.Modules.Utility.Common.Exceptions;
using Discord.Net;
...
namespace EvilMortyBot.Modules.Utility.Services
{
    public class StreamRoleService : INService, IUnloadableService
    {
        ...
        public StreamRoleService(DiscordSocketClient client, DbService db, EvilMortyBot bot)
        {
