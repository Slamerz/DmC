...
{
    public partial class Utility : EvilMortyTopLevelModule
    {
        ...
        public async Task Stats()
        {
            ...
            await Context.Channel.EmbedAsync(
                new EmbedBuilder().WithOkColor()
                    .WithAuthor(eab => eab.WithName($"EvilMortyBot v{StatsService.BotVersion}")
                                          .WithUrl("http://evilMortybot.readthedocs.io/en/latest/")
