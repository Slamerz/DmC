...
using EvilMortyBot.Common.ShardCom;
...
namespace EvilMortyBot
{
    public class EvilMortyBot
    {
        ...
        public EvilMortyBot(int shardId, int parentProcessId)
        {
            if (shardId < 0)
        ...
        private void AddServices()
        {
            ...
            using (var uow = _db.UnitOfWork)
            {
                ...
                LoadTypeReaders(typeof(EvilMortyBot).Assembly);
            }
        ...
        public async Task RunAsync(params string[] args)
        {
            ...
            bool isPublicEvilMorty = false;
#if GLOBAL_NADEKO
            isPublicEvilMorty = true;
#endif
            //unload modules which are not available on the public bot

            if (isPublicEvilMorty)
                CommandService
                    .Modules
                    .ToArray()
        ...
        //                                        "modules",
        //                                        $"EvilMortyBot.Modules.{name}",
        //                                        $"EvilMortyBot.Modules.{name}.dll"));
