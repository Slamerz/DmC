...
namespace EvilMortyBot.Core.Services.Database.Models
{
    public class BotConfig : DbEntity
    {
        ...
        public string CurrencyName { get; set; } = "EvilMorty Flower";
        public string CurrencyPluralName { get; set; } = "EvilMorty Flowers";
...
EvilMorty Support Server: https://discord.gg/evilMortybot";
