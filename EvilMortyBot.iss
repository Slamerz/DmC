...
[Setup]
AppName=EvilMortyBot
AppVersion={#version}
AppPublisher=Kwoth
DefaultDirName={pf}\EvilMortyBot
DefaultGroupName=EvilMortyBot
UninstallDisplayIcon={app}\{#sysfolder}\evilMorty_icon.ico
Compression=lzma2
SolidCompression=yes
OutputDir=userdocs:projekti/EvilMortyInstallerOutput
OutputBaseFilename=EvilMortyBot-setup-{#version}
AppReadmeFile=http://evilMortybot.readthedocs.io/en/latest/Commands%20List/
...
[Run]
Filename: "http://evilMortybot.readthedocs.io/en/latest/JSON%20Explanations/"; Flags: postinstall shellexec runasoriginaluser; Description: "Open setup guide"
...
Name: "{app}\EvilMortyBot"; Filename: "{app}\{#sysfolder}\EvilMortyBot.exe"; IconFilename: "{app}\{#sysfolder}\evilMorty_icon.ico"
Name: "{app}\credentials"; Filename: "{app}\{#sysfolder}\credentials.json" 
Name: "{app}\data"; Filename: "{app}\{#sysfolder}\data" 

; desktop shortcut 
Name: "{commondesktop}\EvilMortyBot"; Filename: "{app}\EvilMortyBot"; Tasks: desktopicon
...
Root: "HKLM"; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; \
    ValueType: String; ValueName: "{app}\{#sysfolder}\EvilMortyBot.exe"; ValueData: "RUNASADMIN"; \
...
Root: "HKCU"; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; \
    ValueType: String; ValueName: "{app}\{#sysfolder}\EvilMortyBot.exe"; ValueData: "RUNASADMIN"; \
    Flags: uninsdeletekeyifempty uninsdeletevalue;
Root: "HKLM"; Subkey: "SOFTWARE\EvilMortyBot"; \
...
[Messages]
WelcomeLabel2=IMPORTANT! READ BELOW!%n%nIt is recommended that you CLOSE any ANTI VIRUS before continuing.%n%nYou can only update v1.4 or newer.%n%nDo not select your old EvilMortyBot folder as an install path if it's not 1.4 or newer.
...
begin
  ...
  begin
    ...
    if FileExists(X + '\{#sysfolder}\data\EvilMortyBot.db') then begin
      ...
      MsgBox(X + '\{#sysfolder}\data\EvilMortyBot.db doesn''t exist', mbConfirmation, MB_YESNO)
    end
  end;
end;
